...
export default function Women() {
 ...
 const [openDropdown, setOpenDropdown] = useState(false);
  ...
  return (
    <div className="min-h-screen pverflow-x-hidden bg-white overflow-x-hidden text-gray-900">
      {/* Top navigation */}
          ...
          <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
            <div className="text-center mt-10 max-w-6xl px-6">
              ...
              <h1 className="text-white text-xl sm:text-2xl md:text-3xl font-bold leading-tight">
                Discover sophisticated womenswear crafted<br /> for the modern ladies. From timeless <br/> essentials to contemporary pieces.
              </h1>
            </div>
          </div>
        </div>
 ...
 <Link to="/shop" className="text-xs md:text-smtext-gray-600">View all →</Link>
        </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {Array(4).fill(0).map((_, i) => (
              <div key={i} className="bg-white border rounded-lg overflow-hidden">
                <img src="/bag.png" alt="Shirts" className="w-full h-48 object-cover" />
                <div className="p-4">
                  <h3 className="text-sm md:text-xl font-semibold">Shirts</h3>
     ...
     <footer className="bg-[#00071B] text-white py-10 px-6 md:px-16 text-sm">
               ...
               <li className="text-sm my-2" >Wishlist</li>
                             ...
                             <div>
                               <h4 className="font-semibold my-2 mb-2">Stay In Touch</h4>
                                                <p className="font-semibold text-xs md:text-sm my-4 mb-2">Stay in touch to get special offers, free giveaways
              ...
              {/* Copyright */}
              <p className="text-xs md:text-sm text-gray-500 mt-4 text-center">&copy; 2025 Your Store</p>
