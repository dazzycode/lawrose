                         ...
                         <div className="absolute inset-0 bg-black/50 flex items-center">
                           <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
                             <div className="max-w-lg">
                               <span className="text-xs md:text-sm text-gray-200 bg-white/20 px-2 py-2 rounded">Golf Club Collection 2025</span>
                               <h1 className="text-white text-3xl md:text-4xl font-bold mt-2">Refined Leisure</h1>
                               <p className="mt-3 text-white/90">
                                Sophisticated sportswear that transitions seamlessly from the golf course to the clubhouse.
                               </p>
                             ...
                             <div className="w-full mx-10 md:w-1/2">
                               <img src="/golf.png" alt="Bloom & Breeze" className="rounded-lg md:h-96 h-48 " />
                             </div>
                           </div>
                         </div>
                       </div>
