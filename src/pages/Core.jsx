   ...
   <header className="w-full bg-white sticky top-0 z-50 shadow-md border-b border-gray-200 px-4 md:px-8 py-3 flex justify-between items-center">
      ...
      {/* Hero section */}
       <section className="relative">
             <div
               className="h-[29rem] w-full bg-center bg-cover"
               style={{ backgroundImage: "url('/collectionbg.png')" }}
             >
               <div className="absolute inset-0 bg-black/50 flex items-center">
                 <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-8">
                   <div className="max-w-lg">
                     <span className="text-xs md:text-sm text-gray-200 bg-white/20 px-2 py-2 rounded">Core Collection 2025</span>
                     <h1 className="text-white text-3xl md:text-4xl font-bold mt-2">Timeless Essentials</h1>
                     <p className="mt-3 text-white/90">
                       Our foundational pieces that transcend seasons and trends. Built to last, designed to endure.
                     </p>
                   ...
                   <div className="w-full mx-10 md:w-1/2">
                     <img src="/core.png" alt="Bloom & Breeze" className="rounded-lg md:h-96 h-48 " />
                   </div>
                 </div>
               </div>
             </div>
